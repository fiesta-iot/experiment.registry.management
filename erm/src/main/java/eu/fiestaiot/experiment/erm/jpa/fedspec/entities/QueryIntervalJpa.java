 ...
 */
@Entity
@Table( name = "queryinterval" )
public class QueryIntervalJpa {
    ...
    @Id
    @GeneratedValue(generator="queryIntervalJpaID")
    @GenericGenerator(name="queryIntervalJpaID", strategy = "guid")
    protected String id;
